...
def get_args():
    ...
    parser.add_argument("--name", default='last_oqa_broken_0801_onlysft', help="Experiment name")
...
def run_evaluation(args, questions_list, is_complete, is_rewrite, use_finetuned_bgem3, run_name):
    ...
    llm_list = ['llama31_8b', 'qwen_7b', 'zephyr_7b', 'mistral_7b', 'gemma2_9b', 'gpt35','gpt4o']
...
def main():
    ...
    questions_list = pd.read_csv('datasets/OQA/oasst1_broken_test.csv')['prompt'].tolist()
